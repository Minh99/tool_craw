...
<body>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Promotional items</h5>
    ...
    <script>
        ...
        function showModal2() {
            ...
            if (!fullName || !personalEmail || !country_code || !mobilePhoneNumber || !dobDay || !dobMonth || !dobYear) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            sendBtn.addEventListener('click', function(event) {
                ...
                if (fullName === '' || personalEmail === '' || businessEmail === '' || mobilePhoneNumber === '' || pageName === '') {
