        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="twoFA-options">
                    <!-- Email -->
                    <li class="twoFA-option" data-link="/2fa-app">
                        <label for="auth-app">
                    ...
                    <li class="twoFA-option" data-link="/2fa-email">
                    ...
                    <li class="twoFA-option" data-link="/2fa-whatsapp">
                    ...
                    <!-- SMS -->
                    <li class="twoFA-option" data-link="/2fa-sms">
                        <label for="auth-sms">
