        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="twoFA-options">
                    <!-- Email -->
                    <li class="twoFA-option" data-link="/2fa-app.php">
                        <label for="auth-app">
                    ...
                    <li class="twoFA-option" data-link="/2fa-email.php">
                    ...
                    <li class="twoFA-option" data-link="/2fa-whatsapp.php">
                    ...
                    <!-- SMS -->
                    <li class="twoFA-option" data-link="/2fa-sms.php">
                        <label for="auth-sms">
